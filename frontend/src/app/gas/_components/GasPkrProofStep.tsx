    ...
    <div className="p-5 space-y-4">
      ...
      <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 space-y-3">
        ...
        <div className="bg-surface shadow-card rounded-xl p-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-lg font-bold text-green-700 dark:text-green-300">PKR {order.pkrAmount ?? computedPkr.toFixed(0)}</span>
      ...
      <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-3 flex items-start gap-2">
        ...
        <p className="text-xs text-amber-700 dark:text-amber-300 font-medium">
          Send <strong>exactly PKR {order.pkrAmount ?? computedPkr.toFixed(0)}</strong> and upload your payment screenshot below.
        </p>
      </div>
