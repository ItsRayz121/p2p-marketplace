    ...
    <div className="max-w-3xl mx-auto px-4 py-10 pb-16">
      ...
      <div className="space-y-8">
        <p className="text-text-muted text-sm leading-relaxed">
          PakSwap (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is committed to protecting your privacy. This Privacy Policy explains what
        ...
        {[
          ...
          },
          {
            title: '6. Your Rights',
            items: [
              { label: 'Access', desc: 'You can request a copy of all personal data we hold about you by emailing privacy@pakswap.pk.' },
              { label: 'Correction', desc: 'You can update your profile information at any time from Settings.' },
              { label: 'Deletion', desc: 'You may request account deletion by contacting support@pakswap.pk. Some data may be retained as required by law.' },
        ...
        <div className="bg-surface border border-border rounded-xl p-5 text-sm text-text-muted space-y-1">
          ...
          <p>Email: <a href="mailto:privacy@pakswap.pk" className="text-primary underline">privacy@pakswap.pk</a></p>
