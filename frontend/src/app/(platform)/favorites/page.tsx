              ...
              <div key={trader.id} className="bg-surface shadow-card border border-border rounded-xl p-4">
                <div className="flex flex-wrap items-start gap-4">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-full text-red-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-500/10 dark:hover:bg-red-950/30 transition-colors flex-shrink-0"
