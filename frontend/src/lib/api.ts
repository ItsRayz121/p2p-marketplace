...
export interface GasCryptoMethods {
  bep20: { address: string | null; network: string; fee: string; feeUsd: number; feeIsLive?: boolean }
  aptos: { address: string | null; network: string; fee: string; feeUsd: number; feeIsLive?: boolean }
}
