...
// Gas affiliate program + live (USDT) referral earnings. Previously the Settings →
// Affiliate tab; consolidated here so the Referral page is the single hub for codes,
// referrals, earnings and affiliate links. The canonical referral code is shown by the
// parent (/referral), so this component intentionally omits the redundant code card.
...
export function ReferralEarnings() {
  ...
  return (
    <div className="space-y-6">
      {/* Affiliate program — application / status (gas_affiliate_enabled) */}
      ...
      {/* Live referral earnings + withdraw (gas_referral_enabled) */}
      {sum.enabled && (
        <>
          <div>
