...
// ── Error normalization ─────────────────────────────────────────────────────
// Delivery failures arrive as raw provider strings ("Request failed with status
// code 500", axios/RPC noise). Admins need an actionable reason, not a 500. This
// classifies the error into a code + human reason + recommended action, keeping
// a truncated raw tail for forensics.
